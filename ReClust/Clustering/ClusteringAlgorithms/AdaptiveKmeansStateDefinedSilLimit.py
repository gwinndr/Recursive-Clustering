...
class AdaptiveKmeansStateDefinedSilLimitReclust_c:
    def __init__(self):
        ...
        self.mAlgorithmName             = "State Defined Adaptive Kmeans (Sil limit)"
        self.mSaveLocation              = "./Outputs/AdaptiveKmeans_StateDefinedSilLimit_"
    ...
    def RunConfigurations(self, stateMap):
        ...
        self.mSilLimit = input("Enter sil limit: ")
    ...
    def ReclusterFunction(self, cluster):
        ...
        if(self.mVerbose):
            ...
            print "Sil limit: " + str(self.mSilLimit)
        ...
        for n_clusters in cluster_solution_nums:
            ...
            if(sil_score > best_sil_score):
                ...
                # Will additionally break, if sil score is greater than the limit
                if(best_sil_score >= self.mSilLimit):
                    if(self.mVerbose):
                        print "Hit sil limit"
                    break
